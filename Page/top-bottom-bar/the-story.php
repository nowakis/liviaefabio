...
?>
    	...
    	<section id="main-slider" class="fixed-height" style="height:700px">      	
            ...
            <!-- MAIN SLIDER IMAGES -->
  			...
  			<div class="slides">
    				<!-- SLIDE IMAGE -->
                	<div data-stellar-ratio="0.5" class="slide-image" style="background-image:url(images/vintage/navio-livia-fabio.jpg); background-position:top">
                    </div>
        ...
        <section id="content">
            ...
            <div class="divider-wrapper">
            	<div class="image-divider fixed-height" style="background-image:url(images/vintage/20160605173100_IMG_7596-wedding.jpg); height:760px" data-stellar-background-ratio="0.5" >
